...
public class CommandFactory {
	...
	Map<String, Integer> myUserCommandsNumArgs; 
	
	public CommandFactory(Map<String, Double> variables, Map<String, String> userDefCommands, Map<String, Integer> userCommandsNumArgs) {
	...
	public Command makeCommand(String commandName, List<Command> commandArgs, Turtle turtle) {
		if(commandName.equals("Forward")) {
			...
			return new DoTimesCommand(commandArgs.get(0), commandArgs.get(1), commandArgs.get(2), turtle, myVariables);
		}
		else if(commandName.equals("If")) {
			return new IfCommand(commandArgs.get(1), commandArgs.get(0), turtle, myVariables); 
		}
		else if (commandName.equals("IfElse")) {
			return new IfElseCommand(commandArgs.get(2), commandArgs.get(0), commandArgs.get(1), turtle, myVariables); 
		}
			...
			return new MakeUserInstructionCommand(commandArgs.get(0), commandArgs.get(1), commandArgs.get(2), myVariables, myUserDefCommands, myUserCommandsNumArgs);
		}
		else {
